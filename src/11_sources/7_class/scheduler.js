...
import { UPDATE, TAG_TEXT, TAG_HOST, Placement, TAG_ROOT, ELEMENT_TEXT, DELETION, TAG_CLASS } from './contants'
...
function beginWork(currentFiber) {
    ...
    console.log("1.1 beginWork", currentFiber.props.key || currentFiber.props.text);
